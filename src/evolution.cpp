...
//
////    ShaderProgram *shader = new ShaderProgram("src/shaders/vert_text.glsl", "src/shaders/frag_text.glsl");
//    Shader shader("src/shaders/vert_text.glsl", "src/shaders/frag_text.glsl");
////    shader->start();
//    shader.Use();
...
//
//    FT_Face face;
//    if (FT_New_Face(ft, "_data/FreeMono.ttf", 0, &face))
...
//////        textRenderer->Print(text, 10, 500, 60);
////
////        // Set gray background
...
int main()
{
    ...
    RenderManager *renderManager = new RenderManager(textRenderer);
